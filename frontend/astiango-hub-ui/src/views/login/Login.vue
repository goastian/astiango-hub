  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="tips">
        ...
        <a
          v-if="false"
          href="https://github.com/goastian/astiango-hub"
          style="float: right"
          target="_blank"
        >
          <img
            alt="github-stars"
            src="https://img.shields.io/github/stars/goastian/astiango-hub?logo=github"
          />
        </a>
      </div>
      <div class="lang">
      ...
      <div v-if="false" class="documentation">
        <a
          href="https://github.com/goastian/astiango-hub/tree/main/docs"
          target="_blank"
        >{{
